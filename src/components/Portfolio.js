...
const palce7 = [
    "다양한 매체에 운동하는 영상이 많이 나오고 있습니다. 그로 인해 사람들이 운동에 대해 관심이 생겨서 많은 사람들이 운동을 하려고 시도하고는 있으나 막상 어떻게 해야될지도 모릅니다. 또한 내 주위에는 운동하는 친구들이 없어서 같이 운동도 하고 소통할 수 있는 페이지를 제작해 보았습니다. ID : wwg0328@naver.com PW : dkssud@12A",
    "교육기관에서의 첫 프로젝트였습니다. 현재까지 배운것을 완벽하게 이해하지도 못했으며 레이아웃도 힘들어서 OTT사이트를 만들면서 복습하는 생각으로 만들었습니다.  ID : wwg0328 PW : dkssud@12",
...
const palce8 = ["2024.01.15 ~ 2024.02.16"," 2023.11.22 ~ 2023.12.06","2024.06.12 ~ 진행중","2024.04.22 ~ 2024.0513","2024.06.10 ~ 진행중"]
function Portfol(){
